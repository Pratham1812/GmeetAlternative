        ...
        <div className="rounded-lg w-full p-6 shadow-md bg-gray-800 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0">
            ...
            <form onSubmit={handleSubmit} className="mt-6 w-4/6 md:w-5/6 gap-2 flex justify-center flex-col mx-auto">
                <div className="">
                    ...
                    <input type="text" placeholder="Enter your full name" className="w-full text-black input input-bordered h-10" 
                ...
                <div className="">
                    ...
                    <input type="text" placeholder="Enter your username" className="w-full text-black input input-bordered h-10" 
                ...
                <div className="">
                    ...
                    <input type="password" placeholder="Enter your passsword" className="w-full text-black input input-bordered h-10"
